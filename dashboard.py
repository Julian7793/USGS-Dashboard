...
# --- REPLACE BROOKVILLE USGS GRAPH ---
# Remove graph for USGS 03275990 (Brookville)
data = [d for d in data if not d["page_url"].endswith("03275990")]

# Add USACE Brookville graph instead
data.insert(1, {
    "title": "Brookville Reservoir (USACE)",
    "page_url": "https://water.usace.army.mil/overview/lrl/locations/brookville",
    "image_url": "https://water.usace.army.mil/f?p=140:9:0::NO::P9_LOCATION_ID:42770"
})
